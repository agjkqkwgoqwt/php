...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($surname_err)){
        ...
        $sql = "UPDATE employees SET name=?, surname=? WHERE id=?";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label>surname</label>
                            <textarea name="surname" class="form-control <?php echo (!empty($surname_err)) ? 'is-invalid' : ''; ?>"><?php echo $surname; ?></textarea>
